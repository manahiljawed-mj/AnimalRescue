...
public class DisplayCat extends JPanel {
    ...
    private JComboBox<String> cboCatSelection; // Declare JComboBox
    private JRadioButton rdbtnSingleCatRecord;
    ...
    public DisplayCat(CardLayout cardLayout, JPanel cardPanel) {
        ...
        // Title Label
        JLabel lblTitle = new JLabel("Display New Cat Record");
     ...
     // Initialize btnBack1
        ...
        btnBack1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cardLayout.show(cardPanel, "Cat"); // Correctly reference cardPanel
            }
        });// Initially hidden
        add(btnBack1);
        // Radio Buttons for selecting view
        rdbtnSingleCatRecord = new JRadioButton("Single Cat Record");
        rdbtnSingleCatRecord.setForeground(SystemColor.controlLtHighlight);
        rdbtnSingleCatRecord.setBackground(new Color(0, 128, 128));
        rdbtnSingleCatRecord.setBounds(215, 110, 189, 23);
        rdbtnSingleCatRecord.setSelected(true); // Default selection
        rdbtnSingleCatRecord.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                showSingleCatRecord();
            }
        });
        add(rdbtnSingleCatRecord);
        ...
        group.add(rdbtnSingleCatRecord);
        group.add(rdbtnAll);

        // Form Panel for Single Cat Record
        ...
        // Labels and Text Fields for Single Cat Record
        ...
        showSingleCatRecord(); // Default view
    }

    private void createFormComponents() {
        // Create and add dropdown for selecting a cat
        JLabel lblSelectCat = new JLabel("Select Cat:");
        lblSelectCat.setFont(new Font("Dialog", Font.BOLD, 16));
        lblSelectCat.setForeground(SystemColor.controlLtHighlight);
        lblSelectCat.setBounds(139, 20, 100, 30);
        formPanel.add(lblSelectCat);

        // Sample data for JComboBox
        String[] catNames = {"Tom", "Whiskers", "Fluffy"}; // Example cat names
        cboCatSelection = new JComboBox<>(catNames);
        cboCatSelection.setBounds(318, 20, 300, 30);
        formPanel.add(cboCatSelection);
...
//        formPanel.add(btnBack);
    ...
    private void showSingleCatRecord() {
